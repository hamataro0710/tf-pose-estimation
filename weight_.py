...
# japanese male average length of body-parts
# units are meter-kg
height = 1.70
weight = 60
foot_length = 0.26
leg_length = 0.43  # from ankle to knee
thigh_length = 0.43 # from knee to troachanter
torso_length = 0.5  # from trochanter to neck
head_length = 0.28 # from neck to head-top
arm_length = 0.3
forearm_length = 0.25
hand_length = 0.19
...
torso_weight = weight-(foot_weight + leg_weight + thigh_weight) * 2\
